...
//if (\Bitrix\Main\Loader::includeModule("exchange.parallel1c") )
//{
//	if ( $arParams["EXCHANGE_PARALLEL1C_SETTINGS_ID"] > 0 )
//	{
//		$res = \Exchange\Parallel1c\ExchangeTable::getById($arParams["EXCHANGE_PARALLEL1C_SETTINGS_ID"]);
//		if ($arFields = $res->fetch() )
//		{
//			$arParams["EXCHANGE_PARALLEL1C_SETTINGS"] = $arFields;
//
//			$table_name = "b_xml_tree_exchange_parallel1c_".$arParams["EXCHANGE_PARALLEL1C_SETTINGS"]["CODE"];
//			$catalog_name = "1c_catalog_exchange_parallel1c_".$arParams["EXCHANGE_PARALLEL1C_SETTINGS"]["CODE"];
//		}
