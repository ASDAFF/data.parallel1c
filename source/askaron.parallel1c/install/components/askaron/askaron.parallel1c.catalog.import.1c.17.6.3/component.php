...
//{
//	if ( $arParams["ASKARON_PARALLEL1C_SETTINGS_ID"] > 0 )
//	{
//		$res = \Askaron\Parallel1c\ExchangeTable::getById($arParams["ASKARON_PARALLEL1C_SETTINGS_ID"]);
//		if ($arFields = $res->fetch() )
//		{
//			$arParams["ASKARON_PARALLEL1C_SETTINGS"] = $arFields;
//
//			$table_name = "b_xml_tree_askaron_parallel1c_".$arParams["ASKARON_PARALLEL1C_SETTINGS"]["CODE"];
//			$catalog_name = "1c_catalog_askaron_parallel1c_".$arParams["ASKARON_PARALLEL1C_SETTINGS"]["CODE"];
//		}
