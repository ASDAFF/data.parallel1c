...
elseif($type=="catalog")
{
	// Askaron++
	if (
		$arAskaronParallelsSettings["COMPONENT_IMPORT_VER"] == "last"
			||
		$arAskaronParallelsSettings["COMPONENT_IMPORT_VER"] == "20.0.0"
	)
	{
		$APPLICATION->IncludeComponent("askaron:askaron.parallel1c.catalog.import.1c.20.0.0", "", Array(
	...
	if ($arAskaronParallelsSettings["COMPONENT_IMPORT_VER"] == "17.6.3")
	{
		$APPLICATION->IncludeComponent("askaron:askaron.parallel1c.catalog.import.1c.17.6.3", "", Array(
				"IBLOCK_TYPE" => COption::GetOptionString("catalog", "1C_IBLOCK_TYPE", "-"),
				"SITE_LIST" => array(COption::GetOptionString("catalog", "1C_SITE_LIST", "-")),
				"INTERVAL" => COption::GetOptionString("catalog", "1C_INTERVAL", "-"),
				"GROUP_PERMISSIONS" => explode(",", COption::GetOptionString("catalog", "1C_GROUP_PERMISSIONS", "1")),
