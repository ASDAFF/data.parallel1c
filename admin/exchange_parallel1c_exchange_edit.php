...
$install_status=CModule::IncludeModuleEx("exchange.parallel1c");


$arGroups = array(
	"group1" => array(
		"NAME" => GetMessage("exchange_parallel1c_exchange_edit_group1"),
		"HELP" => GetMessage("exchange_parallel1c_exchange_edit_group1_help"),
	),
	"group4" => array(
		"NAME" => GetMessage("exchange_parallel1c_exchange_edit_group4"),
		"HELP" => GetMessage("exchange_parallel1c_exchange_edit_group4_help"),
	),
	"group2" => array(
		"NAME" => GetMessage("exchange_parallel1c_exchange_edit_group2"),
		"HELP" => GetMessage("exchange_parallel1c_exchange_edit_group2_help"),
	),
	"group3" => array(
		"NAME" => GetMessage("exchange_parallel1c_exchange_edit_group3"),
		"HELP" => GetMessage("exchange_parallel1c_exchange_edit_group3_help"),
	),
	"group5" => array(
		"NAME" => GetMessage("exchange_parallel1c_exchange_edit_group5"),
		"HELP" => GetMessage("exchange_parallel1c_exchange_edit_group5_help"),
	),
);
...
$arOptions[] = array(
	"CODE" => "CODE",
	"NAME" => GetMessage("exchange_parallel1c_exchange_edit_code"),
	"NAME2" => "",
	"TYPE" => "TEXT",
	"DEFAULT_VALUE" => "",
	"VALUE" => null,
	...
	//"COLS" => 40,
	"SIZE" => 40,
	"HELP" => GetMessage("exchange_parallel1c_exchange_edit_code_help"),
	"GROUP" => "group1",
);

$arOptions[] = array(
	"CODE" => "NAME",
	"NAME" => GetMessage("exchange_parallel1c_exchange_edit_name"),
	"NAME2" => "",
	"TYPE" => "TEXT",
	"DEFAULT_VALUE" => "",
	"VALUE" => null,
	...
	"COLS" => 80,
	//"SIZE" => 80,
	"HELP" => GetMessage("exchange_parallel1c_exchange_edit_name_help"),
	"GROUP" => "group1",
);

$arOptions[] = array(
	"CODE" => "PATH",
	"NAME" => GetMessage("exchange_parallel1c_exchange_edit_path"),
	"NAME2" => "",
	"TYPE" => "TEXT",
	"DEFAULT_VALUE" => "",
	"VALUE" => null,
	...
	//"COLS" => 80,
	"SIZE" => 80,
	"HELP" => GetMessage("exchange_parallel1c_exchange_edit_path_help"),
	"GROUP" => "group1",
);
...
$arOptions[] = array(
	...
	"NAME" => GetMessage("exchange_parallel1c_exchange_disallow_import_xml_step"),
	"NAME2" => "",
	"TYPE" => "CHECKBOX",
	"DEFAULT_VALUE" => "N",
	"VALUE" => null,
	//"ROWS" => 1,
	//"COLS" => 80,
	"HELP" => GetMessage("exchange_parallel1c_exchange_disallow_import_xml_step_help"),
	"GROUP" => "group2",
);
...
$arOptions[] = array(
	...
	"NAME" => GetMessage("exchange_parallel1c_exchange_disallow_offers_xml_step"),
	"NAME2" => "",
	"TYPE" => "CHECKBOX",
	"DEFAULT_VALUE" => "N",
	"VALUE" => null,
	//"ROWS" => 1,
	//"COLS" => 80,
	"HELP" => GetMessage("exchange_parallel1c_exchange_disallow_offers_xml_step_help"),
	"GROUP" => "group2",
);

$arOptions[] = array(
	"CODE" => "DISALLOW_PRICES_XML_STEP",
	"NAME" => GetMessage("exchange_parallel1c_exchange_disallow_prices_xml_step"),
	"NAME2" => "",
	"TYPE" => "CHECKBOX",
	"DEFAULT_VALUE" => "N",
	"VALUE" => null,
	//"ROWS" => 1,
	//"COLS" => 80,
	"HELP" => GetMessage("exchange_parallel1c_exchange_disallow_prices_xml_step_help"),
	"GROUP" => "group2",
);

$arOptions[] = array(
	"CODE" => "DISALLOW_RESTS_XML_STEP",
	"NAME" => GetMessage("exchange_parallel1c_exchange_disallow_rests_xml_step"),
	"NAME2" => "",
	"TYPE" => "CHECKBOX",
	"DEFAULT_VALUE" => "N",
	"VALUE" => null,
	//"ROWS" => 1,
	//"COLS" => 80,
	"HELP" => GetMessage("exchange_parallel1c_exchange_disallow_rests_xml_step_help"),
	"GROUP" => "group2",
);
...
$arOptions[] = array(
	...
	"NAME" => GetMessage("exchange_parallel1c_exchange_disallow_deactivate_step"),
	"NAME2" => "",
	"TYPE" => "CHECKBOX",
	"DEFAULT_VALUE" => "N",
	"VALUE" => null,
	//"ROWS" => 1,
	//"COLS" => 80,
	"HELP" => GetMessage("exchange_parallel1c_exchange_disallow_deactivate_step_help"),
	"GROUP" => "group2",
);
...
//	"NAME" => GetMessage("exchange_parallel1c_exchange_allow_deactivate_iblocks"),
//	"NAME2" => "",
//	"TYPE" => "TEXT",
//	"DEFAULT_VALUE" => "",
//	"VALUE" => null,
...
//	//"COLS" => 40,
//	"SIZE" => 40,
//	"HELP" => GetMessage("exchange_parallel1c_exchange_allow_deactivate_iblocks_help"),
//	"GROUP" => "group4",
//);
...
$arOptions[] = array(
	...
	"NAME" => GetMessage("exchange_parallel1c_exchange_import_xml_new_only"),
	"NAME2" => "",
	"TYPE" => "CHECKBOX",
	"DEFAULT_VALUE" => "N",
	"VALUE" => null,
	//"ROWS" => 1,
	//"COLS" => 80,
	"HELP" => GetMessage("exchange_parallel1c_exchange_import_xml_new_only_help"),
	"GROUP" => "group3",
);
...
$arOptions[] = array(
	...
	"NAME" => GetMessage("exchange_parallel1c_exchange_edit_component_import_ver"),
	"NAME2" => "",
	"TYPE" => "SELECT",
	"DEFAULT_VALUE" => "",
//	"DEFAULT_VALUE" => "last",
	...
	//"ROWS" => 1,
	//"COLS" => 80,
	"HELP" => GetMessage("exchange_parallel1c_exchange_edit_component_import_ver_help"),
	"GROUP" => "group5",
);

$arCatalogImportVersions = \CExchangeParallel1c::GetCml2ImportVersions();
$arValues = array();
foreach ($arCatalogImportVersions as $key=>$arItem)
{
	$arValues[$key] = array(
...
$arOptions[] = array(
	...
	"NAME" => GetMessage("exchange_parallel1c_exchange_edit_cml2_import_ver"),
	"NAME2" => "",
	"TYPE" => "SELECT",
	"DEFAULT_VALUE" => "",
//	"DEFAULT_VALUE" => "last",
	...
	//"ROWS" => 1,
	//"COLS" => 80,
	"HELP" => GetMessage("exchange_parallel1c_exchange_edit_cml2_import_ver_help"),
	"GROUP" => "group5",
);
...
if( $install_status==3 )
{
	$APPLICATION->SetTitle(GetMessage("exchange_parallel1c_exchange_edit_title"));
...
else
{
	...
	if ($ID > 0)
	{
		$res = \Exchange\Parallel1c\ExchangeTable::getById($ID);
		if ($arRes = $res->fetch())
		{
			$arElement = $arRes;
		}
		...
		{
			$strError = GetMessage("exchange_parallel1c_exchange_edit_id_not_found", array("#ID#" => $ID));
		}
	}
...
//				}
			...
			foreach ( $arOptions as $key => $arOption )
			{
				if ( $arOption["REQUIRED"] && strlen( $arOption["VALUE"] ) <= 0 )
				{
					$arWarnings[] = Loc::getMessage(
							"exchange_parallel1c_exchange_edit_field_is_empty",
			...
			if (!$arWarnings)
			{
				...
				if ($ID > 0)
				{
					$res = \Exchange\Parallel1c\ExchangeTable::update($ID, $arFieldsUpdate);
				}
				else
				{
					$res = \Exchange\Parallel1c\ExchangeTable::add($arFieldsUpdate);
				}
				...
				if ($res->isSuccess())
				{
					if ($_REQUEST["save"] != "")
					{
						LocalRedirect("exchange_parallel1c_exchange_admin.php?lang=" . LANG);
					}
	...
	if ( $_REQUEST["OK"] === "Y" )
	{
		$strOk = Loc::getMessage("exchange_parallel1c_exchange_edit_save_ok");
	}

	$aTabs=array(
		array("DIV"=>"edit1",
			"TAB"=>GetMessage("exchange_parallel1c_exchange_edit_title"),
			"ICON"=>"main_user_edit",
			"TITLE"=>GetMessage("exchange_parallel1c_exchange_edit_title")
		),
	);
...
// demo (2)
	...
	<?else:?>
		...
		<?if ( strlen( $arDescription["DATA"]["HELP_URL"] ) > 0 ):?>
			<?=BeginNote();?>
				<a target="_blank" href="<?=htmlspecialcharsbx( $arDescription["DATA"]["HELP_URL"] )?>"><?=GetMessage("exchange_parallel1c_exchange_edit_doc")?></a>
			<?=EndNote();?>
		<?endif?>
